...
public class AWS {
     ...
     * @return 
     */
    public static String getFileContentsFromBucket(String bucketName, String key)
    {
        return null;
    }        
     ...
     * @param file 
     */
    public static void writeFileContentsToBucket(String bucketName, String key, Object file)
    {
     ...
     */
    public static void leaseMachine()
    {
